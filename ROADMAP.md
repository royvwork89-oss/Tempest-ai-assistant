...
- [x] **Gestión de usuarios en UI — v2.4.9** — listar, crear y eliminar usuarios desde el modal de configuración ⚙. Protección contra eliminar usuario `admin` principal.
